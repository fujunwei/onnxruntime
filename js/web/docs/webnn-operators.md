...
| ArgMax | ai.onnx(7-10, 11, 12, 13+) | argMax | ✓ | ✓ | [TFLite only supports scalar axis and first index can be selected](https://source.chromium.org/chromium/chromium/src/+/main:services/webnn/tflite/graph_builder.cc;drc=1adf79d145d0cdb5d6c301f0cf4b2874491c4212;l=752) and [TFLite arg_max doesn't uint64 and int64 data type](https://www.tensorflow.org/mlir/tfl_ops#operands_4) |
| ArgMin | ai.onnx(7-10, 11, 12, 13+) | argMin | ✓ | ✓ | [TFLite only supports scalar axis and first index can be selected](https://source.chromium.org/chromium/chromium/src/+/main:services/webnn/tflite/graph_builder.cc;drc=1adf79d145d0cdb5d6c301f0cf4b2874491c4212;l=752) and [TFLite arg_min doesn't uint64 and int64 data type](https://www.tensorflow.org/mlir/tfl_ops#operands_4) |
| AveragePool | ai.onnx(7-9, 10, 11, 12-18, 19+) | averagePool2d | ✓ | ✓ | [TFLite only doesn't support dilations](https://source.chromium.org/chromium/chromium/src/+/main:services/webnn/tflite/graph_builder.cc;drc=1adf79d145d0cdb5d6c301f0cf4b2874491c4212;l=1428) and [TFLite doesn't support int32, uint32, int64 and uint64 data type](https://www.tensorflow.org/mlir/tfl_ops#operands_8), Only supports 4-D input, 2-D 'kernel_shape', 'count_include_pad' value is 0, |
...
| Clip | ai.onnx(7-10, 11, 12, 13+) | clamp | ✓ | ✓ | [TFLite only support range Relu1, Relu6, Relu](https://source.chromium.org/chromium/chromium/src/+/main:services/webnn/tflite/graph_builder.cc;drc=1adf79d145d0cdb5d6c301f0cf4b2874491c4212;l=101) and [TFLite doesn't support int32, uint32, int64 and uint64 data type](https://www.tensorflow.org/mlir/tfl_ops#tflrelu6_tflrelu6op) |
...
| Gather | ai.onnx(7-10, 11-12, 13+) | gather | ✓  | ✓ |[TFLite doesn't uint32 and uint64](https://www.tensorflow.org/mlir/tfl_ops#operands_48) |
...
| MaxPool | ai.onnx(7, 8-9, 10, 11, 12+) | maxPool2d | ✓ | ✓ | Only supports 4-D input, 2-D 'kernel_shape', 'storage_order' != 1, one output, [TFLite only doesn't support dilations](https://source.chromium.org/chromium/chromium/src/+/main:services/webnn/tflite/graph_builder.cc;drc=1adf79d145d0cdb5d6c301f0cf4b2874491c4212;l=1428) and [TFLite doesn't support int32, uint32, int64 and uint64 data type](https://www.tensorflow.org/mlir/tfl_ops#operands_8) |
| Min | ai.onnx(7, 8-11, 12, 13+) | min | ✓ | ✓ | |
| Mul | ai.onnx(7-12, 13, 14+) | mul | ✓ | ✓ | |
| Neg | ai.onnx(7-12, 13+) | neg | ✓ | ✓ | |
| Not | ai.onnx(7+) | logicalnot | ✓ | ✓ | |
| Pad | ai.onnx(7-10, 11-12, 13-17, 18, 19-20, 21+) | pad | ✓ | ✓ | modes == 'wrap' is not supported, [TFLite don't support edge padding mode](https://source.chromium.org/chromium/chromium/src/+/main:services/webnn/tflite/graph_builder.cc;l=1386;drc=1adf79d145d0cdb5d6c301f0cf4b2874491c4212;bpv=0) and [TFLite doesn't uint32 and uint64](https://www.tensorflow.org/mlir/tfl_ops#operands_77)|
| Pow | ai.onnx(7-11, 12, 13-14, 15+) | pow | ✓ | ✓ | |
| PRelu | ai.onnx(7-8, 9-15, 16+) | prelu | ✓ | ✓ | [The input and slope should have the same last dimension](https://source.chromium.org/chromium/chromium/src/+/main:services/webnn/tflite/graph_builder.cc;drc=1adf79d145d0cdb5d6c301f0cf4b2874491c4212;l=1498) and [TFLite doesn't int32](https://www.tensorflow.org/mlir/tfl_ops#tflprelu_tflpreluop) |
...
| ReduceMax | ai.onnx(7-10, 11, 12, 13-17, 18-19, 20+) | reduceMax | ✓ | ✓ | Input 'axes' if present should be a constant for DirectML backend and [TFLite doesn't uint32 and uint64](https://www.tensorflow.org/mlir/tfl_ops#operands_101) |
| ReduceMean | ai.onnx(7-10, 11-12, 13-17, 18+) | reduceMean | ✓ | ✓ | Input 'axes' if present should be a constant for DirectML backend [TFLite doesn't uint32 and uint64](https://www.tensorflow.org/mlir/tfl_ops#operands_101) |
| ReduceMin | ai.onnx(7-10, 11, 12, 13-17, 18-19, 20+) | reduceMin | ✓ | ✓ | Input 'axes' if present should be a constant for DirectML backend [TFLite doesn't uint32 and uint64](https://www.tensorflow.org/mlir/tfl_ops#operands_101) |
| ReduceProd | ai.onnx(7-10, 11-12, 13-17, 18+) | reduceProduct | ✓ | ✓ | Input 'axes' if present should be a constant for DirectML backend [TFLite doesn't uint32 and uint64](https://www.tensorflow.org/mlir/tfl_ops#operands_101)|
| ReduceSum | ai.onnx(7-10, 11-12, 13+) | reduceSum | ✓ | ✓ | Input 'axes' if present should be a constant for DirectML backend [TFLite doesn't uint32 and uint64](https://www.tensorflow.org/mlir/tfl_ops#operands_101)|
| ReduceSumSquare | ai.onnx(7-10, 11-12, 13-17, 18+) | reduceSumSquare | ✗ | ✓ | Input 'axes' if present should be a constant |
| Relu | ai.onnx(7-12, 13, 14+) | relu | ✓ | ✓ |  [TFLite doesn't int32](https://www.tensorflow.org/mlir/tfl_ops#operands_104)|
...
| Sin | ai.onnx(7+) | sin | ✓ | ✓ | |
| Slice | ai.onnx(7-9, 10, 11-12, 13+) | slice | ✓ | ✓ | Input 'starts', 'ends', 'axes', and 'steps' if present must be a constant, only supports 'steps' value 1 for DirectML backend,  [TFLite doesn't uint64](https://www.tensorflow.org/mlir/tfl_ops#operands_124)|
...
| Transpose | ai.onnx(7-12, 13-20, 21+) | transpose | ✓ | ✓ | [TFLite doesn't uint32 and uint64](https://www.tensorflow.org/mlir/tfl_ops#operands_142)|
| Unsqueeze | ai.onnx(7-10, 11-12, 13-20, 21+) | reshape | ✓ | ✓ | |
| Where | ai.onnx(7-8, 9-15, 16+) | where | ✓ | ✓ |[TFLite doesn't uint64](https://www.tensorflow.org/mlir/tfl_ops#operands_120) |
